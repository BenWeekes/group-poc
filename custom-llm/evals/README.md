...
| `npm run eval:150-turn-compare` | all four profiles + three configs | Primary 75-caller-turn / 150-dialogue-message comparison: immediate team, deferred-handoff team, and single prompt, with per-pass context telemetry |
